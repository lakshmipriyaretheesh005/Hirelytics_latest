        ...
        <div className="container px-4 mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-4 text-zinc-500 text-sm">
                ...
                <li><Link href="#companies" className="hover:text-blue-500 transition-colors">Companies</Link></li>
                <li><Link href="#testimonials" className="hover:text-blue-500 transition-colors">Testimonials</Link></li>
                <li><Link href="/login" className="hover:text-blue-500 transition-colors">Student Login</Link></li>
              </ul>
            </div>
            <div>
          ...
          <div className="pt-8 border-t border-zinc-900 flex flex-col md:row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              <Link href="#" className="text-zinc-600 hover:text-zinc-400 transition-colors text-sm">Privacy Policy</Link>
              <Link href="#" className="text-zinc-600 hover:text-zinc-400 transition-colors text-sm">Terms of Service</Link>
            </div>
          </div>
        </div>
      </footer>
